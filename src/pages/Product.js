  ...
  useEffect(() => {
    ...
    fetch(
      ...
      .then((data) => {
        ...
        setSelectedImage(
          constructedImages.find((image) => image.id === imageId)
        );
      })
      .catch((error) => {
    ...
    <div>
      ...
      >
        <Button
          variant="secondary"
          onClick={() => {
            window.location.href = "/emily-jane-photography/#/collection"; // Replace '/collection' with the actual route to your collection page
          }}
          style={{
            marginBottom: "20px",
            backgroundColor: "white",
            ...
            >
              {selectedImage && selectedImage.title ? (
                <img
                  ...
                  style={{ ...styles.photoImage, border: "none" }}
                ...
                <form>
                        ...
                        <div style={{ display: "flex", alignItems: "center" }}>
                          <Button
                            ...
                            onClick={() => {
                              ...
                              console.log(
                                `Updated quantity: ${quantityInput.value}`
                              );
                  ...
                  <Row>
                    ...
                    <Col
                      ...
                      style={{ paddingRight: "0px", width: "50%" }}
                    >
