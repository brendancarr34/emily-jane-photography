...
const Checkout = () => {
    ...
    // Initialize formData with existing cart details if available
    React.useEffect(() => {
    ...
    const handleChange = (e) => {
        ...
        // Save address immediately when updated
        if (name === 'address') {
            updateCartDetails({ address: value });
        } else if (name === 'name') {
            updateCartDetails({ name: value });
        } else if (name === 'email') {
            updateCartDetails({ email: value });
        } else if (name === 'addressLine2') {
            updateCartDetails({ addressLine2: value });
        } else if (name === 'city') {
            updateCartDetails({ city: value });
        } else if (name === 'state') {
            updateCartDetails({ state: value });
        } else if (name === 'zipCode') {
            updateCartDetails({ zipCode: value });
        }
