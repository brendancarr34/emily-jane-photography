  ...
  if (cart && cart.length === 0) {
    return (
      ...
      >
        ...
        <br />
        <Container
          className="cart-page mt-4 d-flex flex-column align-items-center justify-content-center"
          style={{ flexGrow: 1 }}
        >
              ...
              <Button
                ...
                onClick={() =>
                  (window.location.href =
                    "/emily-jane-photography/#/collection")
                }
              >
      ...
      <Container className="cart-page mt-4 flex-grow-1">
        <Row>
          <Col>
            ...
            <div
              className="mt-2 text-end d-flex align-items-center justify-content-end"
              style={{
                padding: "0px",
            ...
            >
              <Button
                ...
                onClick={() =>
                  (window.location.href =
                    "/emily-jane-photography/#/checkout/shipping")
                }
                style={{
                  padding: "10px 10px",
                  backgroundColor: "#55020e",
