    ...
    >
      ...
      >
        {!loadPage ? (
          ...
          <div
            style={{ opacity: loadPage ? 1 : 0, transition: "opacity 2s ease" }}
          >
                    ...
                    >
                      ...
                      >
                        <a href="/emily-jane-photography/#/collection?collection=California">
                          <img
                            src={require("../resources/collectionPhoto1.jpg")}
                            alt="Collection 1"
                            style={{
                              width: "100%",
                              height: "auto",
                    ...
                    >
                      ...
                      >
                        <a href="/emily-jane-photography/#/collection?collection=Hawaii">
                          <img
                            src={require("../resources/collectionPhoto2.jpg")}
                            alt="Collection 2"
                            style={{
                              width: "100%",
                              height: "auto",
                    ...
                    >
                      ...
                      >
                        <a href="/emily-jane-photography/#/collection?collection=NorthCarolina">
                          <img
                            src={require("../resources/collectionPhoto3.jpg")}
                            alt="Collection 3"
                            style={{
                              width: "100%",
                              height: "auto",
                        ...
                        <h4
                          style={{
                            fontFamily: '"Inter", sans-serif',
                            fontSize: "clamp(0.8rem, 0.5vw, 0.5px)",
                            fontWeight: "700",
                            letterSpacing: "-1px",
                            transform: "scaleX(1.4)",
                          }}
                    ...
                    >
                      ...
                      >
                        <a href="/emily-jane-photography/#/collection?collection=Film">
                          <img
                            src={require("../resources/collectionPhoto4.jpg")}
                            alt="Collection 4"
                            style={{
                              width: "100%",
                              height: "auto",
                    ...
                    >
                      <Col xs={12} sm={12} lg={6}>
                        ...
                        >
                          ...
                          questions about my work, want to collaborate, or just
